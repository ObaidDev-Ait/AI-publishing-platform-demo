    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex flex-1 items-center justify-center gradient-bg relative overflow-hidden">
        ...
        <div className="relative z-10 text-center text-white p-12 max-w-md">
          <h2 className="text-3xl font-bold font-heading mb-4">
            Join the AI publishing revolution
          </h2>
          <p className="text-white/70 leading-relaxed mb-8">
            Create your free account and start generating revenue with AI-powered content.
          </p>
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-12">
        <div className="w-full max-w-[420px]">
          ...
          <h1 className="text-2xl sm:text-3xl font-bold font-heading mb-2">Create an account</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-start gap-2">
              <input type="checkbox" id="terms" className="rounded border-border mt-0.5" defaultChecked />
              <Label htmlFor="terms" className="text-sm text-muted-foreground font-normal cursor-pointer leading-relaxed">
                I agree to the{" "}
                <Link href="#" className="text-violet hover:underline">Terms of Service</Link>
                {" "}and{" "}
                <Link href="#" className="text-violet hover:underline">Privacy Policy</Link>
              </Label>
            </div>
